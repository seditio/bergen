...
<!-- ENDIF -->
						<a href="{PHP|cot_url('users','m=passrecover')}" class="btn btn-primary btn flex-fill">
							<i class="fa fa-unlock d-sm-none"></i>
							<span class="d-none d-sm-inline">{PHP.L.users_lostpass}</span>
						</a>
					</div>
				</form>
			</div>
